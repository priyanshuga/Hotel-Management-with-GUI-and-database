...
class HOTEL_MANGMENT_checkin:
    def __init__(self):
        ...
        self.Label1.place(relx=0.32, rely=0.04, height=37, width=117)
        self.Label1.configure(activebackground="#ffffff")
        self.Label1.configure(activeforeground="black")
        self.Label1.configure(background="#d9d9d9")
        self.Label1.configure(disabledforeground="#a3a3a3")
        self.Label1.configure(font=font11)
        self.Label1.configure(pady=20,padx=20,bd=10)
        ...
        self.Text1.configure(background="darkturquoise")
        ...
        self.Frame2.configure(pady=20,padx=20,bd=10)
        ...
        self.Label2.configure(pady=20,padx=20,bd=10)
        self.Label2.configure(foreground="navy")
        ...
        self.Text2.configure(background="powder blue")
        ...
        self.Text2.configure(pady=20,padx=20,bd=10)
