...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        self.Frame1.configure(highlightbackground="black")
        self.Frame1.configure(highlightcolor="black")
        self.Frame1.configure(pady=16,padx=16,bd=8)
        self.Frame1.configure(width=925)

        self.Message6 = Message(self.Frame1)
        self.Message6.place(relx=0.07, rely=0.01, relheight=0.15, relwidth=0.86)
        self.Message6.configure(background="deepskyblue")
        self.Message6.configure(font=font16)
        self.Message6.configure(foreground="navy")
        self.Message6.configure(highlightbackground="#d9d9d9")
        self.Message6.configure(highlightcolor="black")
        self.Message6.configure(text='''WELCOME TO COMFORT INN''')
        self.Message6.configure(width=791)

        self.Button2 = Button(self.Frame1)
        self.Button2.place(relx=0.25, rely=0.17, height=103, width=566)
        ...
        self.Button3.place(relx=0.25, rely=0.33, height=93, width=566)
        ...
        self.Button4.place(relx=0.25, rely=0.47, height=93, width=566)
        ...
        self.Button4.configure(pady=10,padx=20,bd=10)
        ...
        self.Button5.place(relx=0.25, rely=0.61, height=103, width=566)
        ...
        self.Button6.place(relx=0.25, rely=0.77, height=103, width=566)
